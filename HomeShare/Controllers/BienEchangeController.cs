...
namespace HoliDayRental.Controllers
{
    public class BienEchangeController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            bien.listMembre = _membreService.Get().Select(m => m.ToListMembre());
        ...
        public ActionResult Create(BienEchangeCreate collection)
        {
            try
            {
                ...
                if (!ModelState.IsValid) throw new Exception("ops an error !!");
            ...
            catch (Exception e)
            {
                ...
                collection.listMembre = _membreService.Get().Select(m => m.ToListMembre());
